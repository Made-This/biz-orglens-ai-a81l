...
export default function FounderSnapshotPaymentPage() {
  return (
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-5">
          ...
          <div className="lg:col-span-3">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-zinc-400">
              Get a fast read on your team&rsquo;s structure, role-fit signals,
              and scaling risks.
            </p>
            ...
            <div className="mt-6 rounded-2xl border border-[#1E1E24] bg-[#111113] p-6">
              ...
              <ul className="mt-4 space-y-3 text-sm leading-relaxed text-zinc-300">
                <li className="flex gap-3">
                  ...
                  After purchase, you&rsquo;ll receive intake instructions by
                  email.
                </li>
                <li className="flex gap-3">
                  <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-indigo-400" />
                  Share your team context, current roles, and organizational
                  challenge.
                </li>
                <li className="flex gap-3">
                  <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-indigo-400" />
                  Your report will be delivered within 5&ndash;7 business days.
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
            <div className="sticky top-24 rounded-2xl border border-indigo-400/40 bg-gradient-to-b from-indigo-500/[0.10] to-[#0F0F12] p-7 shadow-[0_0_60px_-15px_rgba(99,102,241,0.45)]">
              ...
              <p className="mt-3 text-sm leading-relaxed text-zinc-400">
                One-time payment. Report delivered within 5&ndash;7 business
                days.
              </p>
