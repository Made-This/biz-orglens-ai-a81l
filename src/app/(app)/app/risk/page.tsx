...
const risks: RiskCard[] = [
  {
    ...
    body: "Only 2 strong leadership profiles (Chifong Dong, Supriya Kumar) across 4 departments. Product division is leadership-dependent on CTO.",
    impact: "If CTO is unavailable → product velocity drops 60%",
  ...
  },
  {
    ...
    title: "Delivery Instability",
    severity: "MEDIUM",
    tone: "amber",
    affected: ["Product", "Operations"],
    body: "High creativity but low structuring in mid-level roles → delivery fragility. Jun Park and Mei Tanaka show structuring gaps that create delivery bottlenecks.",
    impact:
      "Feature release cadence may drop 25% without structured PM oversight",
  ...
  },
  {
    ...
    title: "Single-Point-of-Failure: Operations",
    severity: "HIGH",
    tone: "red",
    affected: ["Operations"],
    body: "Lili Mao is the sole strong stabilizer in Operations. No successor identified. Yuzhe Zhao's profile is not succession-ready.",
    impact: "If Ops Lead leaves",
    simulation: [
      "Support efficiency ↓ 35%",
      "Leadership coverage becomes weak",
      "Onboarding delays increase by 3–4 weeks",
    ],
  ...
  },
  {
    ...
    title: "Management Layer Burnout",
    severity: "MEDIUM",
    tone: "amber",
    affected: ["Product", "Operations"],
    body: "Low coping scores detected in mid-management (Yijun Sim: 6.8 coping, Jun Park: 6.5 coping). High execution pressure without adequate stress management capacity.",
    impact: "6-month voluntary attrition risk: 35% probability",
    icon: <Flame className="h-4 w-4" />,
  },
  {
    id: "conflict",
    number: 5,
    category: "Team Conflict Risk",
    title: "Influence Concentration in Sales",
    severity: "LOW",
    tone: "yellow",
    affected: ["Sales"],
    body: "High influencing concentration around VP Sales (Supriya Kumar: 8.4 influence). Lower-level sales team members may feel overshadowed — collaboration friction risk.",
    impact: "Sales team cohesion score: 6.1/10",
