...
export const blogPosts: BlogPost[] = [
  ...
  {
    slug: "series-b-org-structure-mistake",
    title: "The Org Structure Mistake That Kills Series B Momentum",
    category: "Org Design for Growing Teams",
    author: "OrgLens Team",
    publishDate: "2026-05-12",
    tags: [
    ...
    status: "published",
    seoTitle: "The Org Structure Mistake That Kills Series B Momentum",
    seoDescription:
      "Most founders over-hire to solve execution problems before Series B — but adding headcount before clarifying ownership multiplies the confusion. Here's what actually breaks and how to fix it.",
    summary:
